...
//ボタンの有効化・無効化
    ...
    //加算
    if (kyoka==="国語"){
        saves.splice(0, 1, saves[0]+min_only);
    };
    if (kyoka==="数学"){
        saves.splice(1, 1, saves[1]+min_only);
    };
    if (kyoka==="理科"){
        saves.splice(2, 1, saves[2]+min_only);
    };
    if (kyoka==="社会"){
        saves.splice(3, 1, saves[3]+min_only);
    };
    if (kyoka==="英語"){
        saves.splice(4, 1, saves[4]+min_only);
    };
    //ボタンの有効化・無効化
